...
export const TESTIMONIALS = [
  {
    quote:
      "Splitr has completely streamlined our expense tracking. Settling group payments is effortless now.",
    name: "Aryan Mehta",
    image: "/testimonials/pic1.jpg",
    role: "Product Manager, FinTech",
  },
  {
    quote:
      "We use Splitr for team outings and project expenses — it saves us hours of manual reconciliation.",
    name: "Rohan Kulkarni",
    image: "/testimonials/pic2.jpg",
    role: "Finance Lead, Startup",
  },
  {
    quote:
      "Splitr makes expense sharing transparent and fair. It’s become an essential tool for our remote team.",
    name: "Rohan Sharma",
    image: "/testimonials/pic3.jpg",
